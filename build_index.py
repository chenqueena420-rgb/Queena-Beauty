...
<head>
<meta charset="UTF-8" />
<meta name="description" content="wave wave AI 提供 AI 精準分析，專為敏弱肌與乾性肌篩選醫美修護乳霜，讓您輕鬆找到適合的保養產品。">
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<title>Queena Beauty Shop | AI 精準醫美保養篩選平台</title>
<style>
...
<h1>美妝選品搜尋</h1>
<p class="sub">加權搜尋：<strong>產品名稱</strong>與<strong>解決痛點</strong>權重最高；<strong>核心成分／特性</strong>與<strong>適合膚質</strong>次之。支援模糊比對（子字串，例如「乾」→「乾燥」「乾肌」）。資料以 <code>const productData</code> 內嵌，無 fetch、不需選檔。</p>
...
function renderBuyButtons(p) {{
    ...
    // yahoo購物
    if (b !== "#" && b !== "") {{
        activeButtons += '<a class="btn-buy" href="' + b + '" target="_blank" style="color: #000000 !important; text-decoration: none; display: block; text-align: center; font-weight: bold; margin-bottom: 8px; border: 1px solid #ccc; padding: 8px; border-radius: 4px; background: #fff;">前往 yahoo購物 購買</a>';
    }} else {{
